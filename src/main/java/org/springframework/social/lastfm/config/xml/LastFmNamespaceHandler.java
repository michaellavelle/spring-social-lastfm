...
/**
 * {@link NamespaceHandler} for Spring Social LastFm
 * 
 * @author Michael Lavelle
 */
public class LastFmNamespaceHandler extends AbstractProviderConfigNamespaceHandler {

	@Override
	protected AbstractProviderConfigBeanDefinitionParser getProviderConfigBeanDefinitionParser() {
		return new LastFmConfigBeanDefinitionParser();
	}
